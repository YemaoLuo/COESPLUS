<template>
  <n-card :bordered="false" class="proCard">
    ...
    <!--    <n-modal-->
    <!--      v-model:show="showExportstudentModal"-->
    <!--      :show-icon="false"-->
    <!--      preset="dialog"-->
    <!--      title="导出课程学生信息"-->
    <!--    >-->
    <!--      <n-form-->
    <!--        :model="exportstudentformParams"-->
    <!--        ref="formRef"-->
    <!--        label-placement="left"-->
    <!--        :label-width="80"-->
    <!--        class="py-4"-->
    <!--      >-->
    <!--        <n-form-item label="课程编号" path="courseId">-->
    <!--          <n-input placeholder="请输入课程编号" v-model:value="exportstudentformParams.courseId" />-->
    <!--        </n-form-item>-->
    <!--        <n-form-item label="禁用状态" path="isDeleted">-->
    <!--          <n-select-->
    <!--            v-model:value="exportstudentformParams.isDeleted"-->
    <!--            placeholder="请选择禁用状态"-->
    <!--            :options="isDeletedList"-->
    <!--          />-->
    <!--        </n-form-item>-->
    ...
    <!--      <template #action>-->
    <!--        <n-space>-->
    <!--          <n-button @click="() => (showExportstudentModal = false)">取消</n-button>-->
    <!--          <n-button type="info" :loading="formBtnLoading" @click="confirmExportstudentForm"-->
    <!--            >确定</n-button-->
    <!--          >-->
    <!--        </n-space>-->
    <!--      </template>-->
